...
namespace Infra.Migrations
{
    ...
    [Migration("20231031034527_InicialDbNewTables")]
    partial class InicialDbNewTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.Paciente", b =>
                {
                    ...
                    b.Property<int>("IdPacienteConvenio")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdPacienteConvenio");

                    b.HasIndex("IdPacienteFamiliar");
            ...
            modelBuilder.Entity("Entities.Models.UsuarioClinica", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Models.Paciente", b =>
                {
                    b.HasOne("Entities.Models.PacienteConvenio", "PacienteConvenio")
                        .WithMany()
                        .HasForeignKey("IdPacienteConvenio")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities.Models.PacienteFamiliar", "PacienteFamiliar")
                        .WithMany()
                        .HasForeignKey("IdPacienteFamiliar")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
